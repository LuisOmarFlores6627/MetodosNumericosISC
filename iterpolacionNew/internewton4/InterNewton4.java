package internewton4;

public class InterNewton4 {

    public static void main(String[] args) 
    {
         // Valores de ejemplo
        int n = 3; // Número de puntos de datos
        double[] x = {1.0, 2.0, 4.0}; // Valores de x
        double[] y = {2.0, 3.0, 5.0}; // Valores de y
        double valorX = 3.0; // Valor de x para interpolar
...
//------------Salida en pantalla---------------
//El resultado de la interpolación en x=3.0 es y=4.0